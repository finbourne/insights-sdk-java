...
public class QueriedRequestLog {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timestamp, queriedRequestLog.timestamp) &&
        ...
        (this.duration.compareTo(queriedRequestLog.getDuration()) == 0) &&
  ...
  * @throws IOException if the JSON Element is invalid with respect to QueriedRequestLog
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QueriedRequestLog.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QueriedRequestLog is not found in the empty JSON string", QueriedRequestLog.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : QueriedRequestLog.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QueriedRequestLog.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QueriedRequestLog' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QueriedRequestLog> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QueriedRequestLog.class));

       return (TypeAdapter<T>) new TypeAdapter<QueriedRequestLog>() {
           @Override
           public void write(JsonWriter out, QueriedRequestLog value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QueriedRequestLog read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to QueriedRequestLog
  */
  public static QueriedRequestLog fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QueriedRequestLog.class);
  }
