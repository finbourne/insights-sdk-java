...
import com.finbourne.insights.extensions.auth.HttpFinbourneTokenProvider;
import com.finbourne.insights.extensions.auth.RefreshingTokenProvider;
import com.finbourne.insights.extensions.auth.FinbourneToken;
...
public class ApiClientBuilder {
    ...
    * for communicating with lusidInsights via the APIs
    *
    ...
    *
    * @param apiConfiguration configuration to connect to lusidInsights API
    * @return
    *
